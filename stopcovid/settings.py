"""
Django settings for stopcovid project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "stopcovid.context_processors.extra_settings",
            ]
        },
    }
]

WSGI_APPLICATION = "stopcovid.wsgi.application"
